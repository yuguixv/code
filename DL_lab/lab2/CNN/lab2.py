...
if __name__ == '__main__':
    ...
    plot_history(cnn_hist, "Base CNN (10% Data)")
    ...
    plot_history(fnn_hist, "FNN (10% Data)")
    ...
    plot_history(robust_hist, "CNN with BN & Dropout")
    ...
    plot_history(cnn_50_hist, "Base CNN (50% Data)")
